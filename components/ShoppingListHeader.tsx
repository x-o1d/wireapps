...
function ShoppingListHeader() {
  ...
  const searchByName = (textInput: string) => {
    filteredProducts.set(
      products.value.filter(i =>
        i.name.toLowerCase().includes(textInput.toLowerCase()),
      ),
    );
    ...
    <View style={styles.header}>
      <View style={styles.headerSearch}>
        ...
        <TouchableOpacity
          ...
          />
          <Text style={styles.cartCount} accessibilityHint="cart count">
            ({' '}
      ...
      <View>
        ...
        <TouchableOpacity style={styles.sortButton} onPress={sortPressed}>
          <Text style={styles.sortText}>Sort by: </Text>
          <Text style={styles.sortSelectionText}>
